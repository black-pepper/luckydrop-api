...
public enum ErrorCode {
    ...
    CONTENT_PERIOD_INVALID(HttpStatus.BAD_REQUEST, "시작일은 종료일보다 이전이어야 합니다."),
    CONTENT_NOT_STARTED(HttpStatus.BAD_REQUEST, "아직 이벤트 기간이 시작되지 않았습니다."),
    CONTENT_EXPIRED(HttpStatus.BAD_REQUEST, "이벤트 기간이 종료되었습니다."),
